...
test_database["Date"] = pd.to_datetime(test_database["Date"]) # convert date column to datetimeformat
...
# Store Excel file
"""
writer = pd.ExcelWriter(production_database_path, engine = 'xlsxwriter')
